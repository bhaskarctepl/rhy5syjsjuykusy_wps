...
public class UpdateSupportMaterialRequest {
	...
	private Integer supportMaterialDetailsId;
	...
	public Integer getSupportMaterialDetailsId() {
		return supportMaterialDetailsId;
	}

	public void setSupportMaterialDetailsId(Integer supportMaterialDetailsId) {
		this.supportMaterialDetailsId = supportMaterialDetailsId;
	}
