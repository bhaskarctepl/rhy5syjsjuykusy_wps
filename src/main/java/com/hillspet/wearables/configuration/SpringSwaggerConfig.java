...
public class SpringSwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				...
				.build().enable(false).apiInfo(apiInfo());
	}
	...
	public ApiInfo apiInfo() {
		...
		return new ApiInfo("Wearables Portal Webservices Documentation",
				"This document contains all the details about the webservices which are using in Wearables Portal",
